...
$DevelopmentCard1->setAlignment('center');
$DevelopmentCard1->setIcon('fa-solid fa-cubes');
$DevelopmentCard1->showIcon(true);
...
$DevelopmentCard2->setAlignment('center');
$DevelopmentCard2->setIcon('fa-solid fa-microchip');
$DevelopmentCard2->showIcon(true);
$DevelopmentCard2->setTitle('Microservice Mindset');
$DevelopmentCard2->setExcerpt('This approach offers clients increased agility and scalability by breaking down complex systems into smaller, independent services that can be developed, deployed, and scaled individually. By enabling clients to efficiently adapt to changing market demands, it ultimately ensures the long-term success and competitiveness of their web applications.');
$DevelopmentCard2->showButton(false);

$DevelopmentCard3 = new Card();
$DevelopmentCard3->setAlignment('center');
$DevelopmentCard3->setIcon('fa-solid fa-atom');
$DevelopmentCard3->showIcon(true);
...
$DevelopmentCard4->setAlignment('center');
$DevelopmentCard4->setIcon('fa-brands fa-jira');
$DevelopmentCard4->showIcon(true);
